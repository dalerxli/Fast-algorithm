...
class Scattering3DP 
{
    ...
    public:
        ...
        {            
            ...
            NumParticlePerSide = round(cbrt(TotalParticles));
            NumParticlePerPlane = pow(NumParticlePerSide,2);
            NumCubePerSide = round(cbrt(TotalCubes));
	    ...
	    DomainSize = cbrt(VolQ);
            ...
            NumCollocationPointsPerSide = round(cbrt(TotalCollocationPoints));
...
/*These code for small number of cubes:
