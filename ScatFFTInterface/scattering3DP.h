...
class Scattering3DP 
{
    ...
    public:
    	 ...
    	 inline const Integer Index2Order(Integer m1,Integer m2,Integer m3)
	 {
    	 ...
    	 inline const void Order2Index(Integer m,Integer& m1,Integer& m2,Integer& m3)
	 {
              Integer red1;
        ...
        inline const void Cube2Position(Long m,Real& xm,Real& ym,Real& zm)
        {
		Integer m1,m2,m3;
        ...
        void UniformDistributeCubes()
        {
    	 ...
    	 inline const void ParticleOrder2Index(Integer m,Integer& m1,Integer& m2,Integer& m3)
	 {
              Integer red1;
    	 ...
    	 inline const void CollocationPointOrder2Index(Integer m,Integer& m1,Integer& m2,Integer& m3)
	 {
              Integer red1;
